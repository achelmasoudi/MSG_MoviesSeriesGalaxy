...
class AdapterOfAll(var context: Context , var allList: ArrayList<ModelOfAll>) : RecyclerView.Adapter<AdapterOfAll.MyViewHolder>() {
    ...
    override fun onBindViewHolder(holder: MyViewHolder, position: Int) {
        ...
        if (modelOfAll.iconId == 1) {
            ...
            holder.icon.setImageResource(R.drawable.love_comments_reaction)
        }
        else if (modelOfAll.iconId == 3) {
            holder.icon.setImageResource(R.drawable.laugh_comments_reaction)
        }
        else holder.icon.setImageResource(R.drawable.angry_comments_reaction)
    }
    ...
    inner class MyViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) , View.OnClickListener {
        ...
        private fun showPic() {
            ...
            var model = allList.get(position)
