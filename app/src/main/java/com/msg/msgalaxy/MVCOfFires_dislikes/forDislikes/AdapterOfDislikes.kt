...
class AdapterOfDislikes(var context: Context, var dislikesList: ArrayList<ModelOfDislikes>) : RecyclerView.Adapter<AdapterOfDislikes.MyViewHolder>() {
    ...
    override fun getItemCount(): Int = dislikesList.size

    override fun onBindViewHolder(holder: MyViewHolder, position: Int) {
        var modelOfDislikes: ModelOfDislikes = dislikesList.get(position)
        holder.username!!.text = modelOfDislikes.username
        holder.dislikeIcon!!.setImageResource(R.drawable.selected_dislike_icon)

        //Glide for downloaing the profile picture from Fb
        Glide.with(context).load(modelOfDislikes.profilePic).listener(object : RequestListener<Drawable> {
    ...
    inner class MyViewHolder(i: View) : RecyclerView.ViewHolder(i) {
        ...
        var dislikeIcon: ImageView? = null
        ...
        init {
            ...
            dislikeIcon = i.findViewById(R.id.firesDislikesCardItem_firesOrDislikesIconId)
        ...
        private fun showPic() {
            ...
            var modelOfDislikes = dislikesList.get(position)
            ...
            Glide.with(context).load(modelOfDislikes.profilePic).apply(RequestOptions.fitCenterTransform()).into(profilePicImageView)
        }
    }
}